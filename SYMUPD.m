...
% Indefinite symmetric matrix factorization form: Q * A * Q' = M * B * M'
% where M is lower triangle matrix and B is block diagonal matrix of size
% 2, and Q is permutation matrix (stored in VECTOR form). 

% Updating the factorization for rank-one update A + sigma * z * z', where
% SIGMA is a scalar, Z is a vector.
% CHANGE: block structure indicator for B.
% p is the dimension of the parameter.
